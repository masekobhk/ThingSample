sap.ui.define([
	...
	"ThingSample/model/formatter"
], function (Controller, formatter) {
	"use strict";

	return Controller.extend("ThingSample.controller.ThingPage", {
		formatter: formatter,
		onInit: function () {
		...
		_readDetailsService: function (oDetailsModel, sThingId) {
			...
			oDetailsModel.read("/Things('" + sThingId + "')", {
				urlParameters: {
					"$expand": "DYN_ENT_dapt_ox181026100231_vivotanks__BhkDip_Reading,DYN_ENT_dapt_ox181026100231_vivotanks__Image,DYN_ENT_dapt_ox181026100231_vivotanks__BhkSite"
				},
